...
namespace Mis333ksp18Group17.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MovieID,MovieNum,Title,Tagline,ReleaseDate,MPAARating,Actors,Runtime,Overview,Revenue")] Movie movie, int[] SelectedGenres)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MovieID,MovieNum,Title,Tagline,ReleaseDate,MPAARating,Actors,Runtime,Overview,Revenue")] Movie movie, int[]SelectedGenres)
        {
            if (SelectedGenres == null)
            {
                ViewBag.ErrorM = "You must select at least a genre.";
